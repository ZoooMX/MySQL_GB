...
### Lesson_10. Первая часть Курсового проекта. 
##### Практическое задание по первой части Курсового проекта.
1. DDL-команды. 
2. Скрипт наполнения таблиц данными, 10-100 строк в каждой таблице (можно пользоваться генераторами данных).
##### Выполнение:
[sql_скрипт_Первая_часть_Курсового_проекта](https://github.com/ZoooMX/MySQL_GB/blob/main/10_lesson%20-%20course%20project/DB_course_project_OHS.sql)

### Lesson_11. Оптимизация запросов. NoSQL
[Исходные данные](https://github.com/ZoooMX/MySQL_GB/blob/main/11_lesson/HW_11_lesson.sql)
##### Практическое задание по теме "Оптимизация запросов. NoSQL"
1. Создайте таблицу logs типа Archive. Пусть при каждом создании записи в таблицах users, catalogs и products в таблицу logs помещается время и дата создания записи, название таблицы, идентификатор первичного ключа и содержимое поля name.
2. Создайте SQL-запрос, который помещает в таблицу users миллион записей.
##### Выполнение:
[sql_скрипт](https://github.com/ZoooMX/MySQL_GB/blob/main/11_lesson/HW_11_lesson.sql)

### Lesson_12. Вторая часть Курсового проекта. 
##### Практическое задание по второй части Курсового проекта.
1. Скрипты характерных выборок (включающие группировки, JOIN'ы, вложенные таблицы) 
##### Выполнение:
[sql_скрипт_Вторая_часть_Курсового_проекта](https://github.com/ZoooMX/MySQL_GB/blob/main/12_lesson%20-%20cource%20project(finished)/EX_course_project_OHS.sql)
