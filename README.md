...
##### Выполнение:
[sql_скрипт_Первая часть Курсового_проекта](https://github.com/ZoooMX/MySQL_GB/blob/main/10_lesson%20-%20course%20project/DB_course_project_OHS.sql)
...
##### Выполнение:
[sql_скрипт_Вторая часть Курсового_проекта](https://github.com/ZoooMX/MySQL_GB/blob/main/12_lesson%20-%20cource%20project(finished)/EX_course_project_OHS.sql)
